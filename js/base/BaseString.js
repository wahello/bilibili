 ...
 */
    ...
    const CANCEL:string = '取消';
    const SEARCH_CONTEXT = '书名,作者,分类';

    const SEARCH_HOT_WORD = '搜索热词';
    const HOT_RECOMMENDED = '热门推荐';
    const BATCH = '换一批';
...
export {
    ...
    BOOK_LOADING_GIF,BOOK_COMMENT_TAB,COLLECTION,DISCUSSION_SENTIMENT,TODA_ADD_DISCUSS,CANCEL,
    SEARCH_CONTEXT,SEARCH_HOT_WORD,HOT_RECOMMENDED,BATCH
}